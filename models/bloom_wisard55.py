import numpy as np
from .wrappers import CcBloomWiSARD55
from .model import Model

class BloomWiSARD55(Model):
    def __init__(self, num_inputs, tuple_lenght, num_filters, filter_tuple_lenght, num_classes):
        ...
        self.__model = CcBloomWiSARD55(num_inputs, tuple_lenght, num_filters, filter_tuple_lenght, num_classes)
