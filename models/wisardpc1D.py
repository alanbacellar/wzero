import numpy as np
from .wrappers import CcWiSARDPC1D
from .model import Model

class WiSARDPC1D(Model):
    def __init__(self, x_dim, z_dim, window_size, stride, tuple_lenght, num_classes):
        
        # self.__num_inputs = num_inputs
        # self.__tuple_lenght = tuple_lenght
        # self.__num_classes = num_classes
        
        self.__model = CcWiSARDPC1D(x_dim, z_dim, window_size, stride, tuple_lenght, num_classes)
